            ...
            if (messageCreateEvent.getMessageContent().startsWith("+wrc")) {
                ...
                if (list.size() == 2) {
                    ...
                    try {
                        ...
                        Permissions deniedPerms = new PermissionsBuilder().setDenied(PermissionType.READ_MESSAGES).build();
                        ...
                        Channel warroomChannel = new ServerTextChannelBuilder(server.get())
                                ...
                                .addPermissionOverwrite(server.get().getRoleById(staffId).get(), new PermissionsBuilder().setAllowed(PermissionType.READ_MESSAGES).build())
                                .addPermissionOverwrite(server.get().getRoleById(govRole).get(), new PermissionsBuilder().setAllowed(PermissionType.READ_MESSAGES).build())
                                .addPermissionOverwrite(server.get().getRoleById(hkRole).get(), new PermissionsBuilder().setAllowed(PermissionType.READ_MESSAGES).build())
                        ...
                        if (defensiveWars.size() > 0) {
                            defWarCount = offensiveWars.size();
                ...
                if (!messageCreateEvent.getChannel().getIdAsString().equalsIgnoreCase(commandsChannel)) {
                    ...
                    if (list.size() != 2) {
                        ...
                        try {
                            ...
                            ServerChannelUpdater scu = channel.asServerTextChannel().get().createUpdater();

                            Permissions permissions = new PermissionsBuilder().setAllowed(PermissionType.READ_MESSAGES).build();
                ...
                if (!messageCreateEvent.getChannel().getIdAsString().equalsIgnoreCase(commandsChannel)) {
                    ...
                    if (list.size() != 2) {
                        ...
                        try {
                            ...
                            Permissions permissions = new PermissionsBuilder().setDenied(PermissionType.READ_MESSAGES).build();
